...
class Command(BaseCommand):
    help = 'Import senators data from JSON file into the Leaders model'
    ...
    def handle(self, *args, **options):
        ...
        for county_code, senator_name in data.items():
        ...
        self.stdout.write(self.style.SUCCESS('Successfully imported senators.'))
